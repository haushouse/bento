...
{% include caption.html sideBySide=false url="/assets/images/bc_phone1.png" description="Mobile main menu.<br> The last component of the card we changed was the element symbols." %} 
